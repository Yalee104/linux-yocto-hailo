...
#    define HAILO15_SCMI_CLOCK_IDX_I2S_CLK_DIV 30
...
/* power domain IDs */
#define HAILO15_SCMI_POWER_DOMAIN_IDX_VISION_SUBSYS 0
#define HAILO15_SCMI_POWER_DOMAIN_IDX_SYSTOP 1
#define HAILO15_SCMI_POWER_DOMAIN_COUNT 2
